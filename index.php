...
<div class="container">
  ...
  <div class="card p-3">
    <h5>Quick test instructions</h5>
    <ol>
      <li>Open Notepad to test scanner first — it should type the ID and press Enter.</li>
      <li>Ensure the input (above) is focused; when scanner sends Enter, the form submits.</li>
      <li>To avoid duplicates, we only allow one record per student per calendar day.</li>
    </ol>
  </div>
</div>
